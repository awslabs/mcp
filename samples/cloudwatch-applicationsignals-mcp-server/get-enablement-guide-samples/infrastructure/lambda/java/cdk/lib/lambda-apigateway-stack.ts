...
export class LambdaApiGatewayStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: LambdaApiGatewayStackProps) {
    ...
    const lambdaFunction = new lambda.Function(this, 'LambdaFunction', {
      ...
      code: lambda.Code.fromAsset('../sample-app/target/lambda-sample-1.0.0.jar'),
      memorySize: 512,
    ...
    const api = new apigateway.LambdaRestApi(this, `ApiGateway-Lambda-java-cdk-${Math.random().toString(36).substring(2, 10)}`, {
      handler: lambdaFunction,
      proxy: true,

    });

    new cdk.CfnOutput(this, 'JavaFunctionName', {
