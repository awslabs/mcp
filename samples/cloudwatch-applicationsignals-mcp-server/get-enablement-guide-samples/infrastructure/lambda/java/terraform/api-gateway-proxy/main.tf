...
resource "aws_api_gateway_method" "lambda_api_proxy_root_java" {
  rest_api_id   = aws_api_gateway_rest_api.lambda_api_proxy.id
...
resource "aws_api_gateway_integration" "lambda_api_root_java" {
  rest_api_id = aws_api_gateway_rest_api.lambda_api_proxy.id
  resource_id = aws_api_gateway_method.lambda_api_proxy_root_java.resource_id
  http_method = aws_api_gateway_method.lambda_api_proxy_root_java.http_method
...
resource "aws_api_gateway_deployment" "lambda_api_proxy" {
  depends_on = [
    ...
    aws_api_gateway_integration.lambda_api_root_java,
  ]
...
resource "aws_lambda_permission" "lambda_api_allow_gateway_java" {
