...
"""awslabs code-doc-generation MCP Server implementation.
...
from awslabs.code_doc_generation_mcp_server.utils.templates import (
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='An AWS Labs Model Context Protocol (MCP) server for code-doc-generation'
    )
