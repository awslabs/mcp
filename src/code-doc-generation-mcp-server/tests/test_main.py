...
from awslabs.code_doc_generation_mcp_server.server import main
...
class TestMain:
    ...
    @patch('awslabs.code_doc_generation_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.code-doc-generation-mcp-server'])
    ...
    @patch('awslabs.code_doc_generation_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.code-doc-generation-mcp-server', '--sse', '--port', '9999'])
    def test_main_sse(self, mock_run):
        ...
        from awslabs.code_doc_generation_mcp_server.server import mcp
    ...
    def test_module_execution(self):
        ...
        import inspect
        from awslabs.code_doc_generation_mcp_server import server
