    ...
    plan = DocumentationPlan(
        ...
        docs_outline=[
            DocumentSpec(
                ...
                type='README',
                template='README',
                sections=[DocumentSection(title='Test Section', content='', level=1, message=None)],
            ),
        ],
    )
...
async def test_generate_docs_with_log_messages():
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        with patch.object(generator, '_generate_content', return_value='README.md content'), \
...
def test_get_component_summary():
    ...
    analysis3 = ProjectAnalysis(
        ...
        apis={'users': {'get': {'description': 'Get users'}, 'post': {'description': 'Create user'}}},
    )
...
async def test_generate_content():
    ...
    doc_spec = DocumentSpec(
        ...
        sections=[
            ...
            DocumentSection(title='Architecture', content='', level=1, message=None),  # For diagram
