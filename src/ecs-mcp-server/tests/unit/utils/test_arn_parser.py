...
class TestArnParser(unittest.TestCase):
    ...
    def test_parse_arn_cluster(self):
        ...
        arn = "arn:aws:ecs:us-west-2:<account-id>:cluster/test-app-cluster"
        parsed = parse_arn(arn)
    ...
    def test_get_task_definition_name(self):
        ...
        not_task_def = "arn:aws:ecs:us-west-2:<account-id>:cluster/test-app-cluster"
    ...
    def test_is_ecs_cluster(self):
        ...
        # Not a cluster ARN
        not_cluster = "arn:aws:ecs:us-west-2:<account-id>:task-definition/test-app:1"
    ...
    def test_get_resource_name(self):
        ...
        # Task definition ARN
        task_def_arn = "arn:aws:ecs:us-west-2:<account-id>:task-definition/test-app:1"
        self.assertEqual(get_resource_name(task_def_arn), "1")

        # Cluster ARN
        cluster_arn = "arn:aws:ecs:us-west-2:<account-id>:cluster/test-app-cluster"
