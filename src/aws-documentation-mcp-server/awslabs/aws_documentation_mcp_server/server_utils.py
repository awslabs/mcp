...
def add_search_result_cache_item(search_responses: SearchResponse) -> None:
    ...
    Args:
        search_responses: SearchResponse object returned by the search_documentation tool

    Returns:
        None; updates the global SEARCH_RESULT_CACHE

    """
    SEARCH_RESULT_CACHE.appendleft(search_responses)
