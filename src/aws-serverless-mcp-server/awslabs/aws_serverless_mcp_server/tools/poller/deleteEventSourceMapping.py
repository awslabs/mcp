...
class DeleteEventSourceMapping:
    ...
    def __init__(self):
        """Initialize the DeleteEventSourceMapping tool."""
    ...
    def delete_esm_by_function_and_source(
        ...
        try:
            ...
            mappings = self.lambda_client.list_event_source_mappings(FunctionName=function_name)
            ...
            if not target_mapping:
                ...
                self.logger.warning(
                    f'No matching Event Source Mapping found for function {function_name} and {source_type} {source_identifier}'
                )
