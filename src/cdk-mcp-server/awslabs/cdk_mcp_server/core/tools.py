...
def save_fallback_script_to_file(script_content: str, lambda_code_path: str, output_path: str) -> str:
    ...
    scripts_dir = os.path.join(os.path.dirname(os.path.abspath(output_path)), "scripts")
    os.makedirs(scripts_dir, exist_ok=True)
    
    # Generate a unique script name based on the Lambda file name
    lambda_file_name = os.path.basename(lambda_code_path).replace(".py", "")
    script_file_name = f"generate_schema_{lambda_file_name}.py"
