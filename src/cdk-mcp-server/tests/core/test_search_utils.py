...
def test_calculate_match_score_basic():
    ...
    result = calculate_match_score("test description with multiple test words", ["test", "multiple"])
...
def test_search_items_with_terms():
    ...
    # Test basic search
    results = search_items_with_terms(
        items,
        ["lambda"],
        get_text,
        get_name_parts
