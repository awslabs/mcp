...
async def test_fetch_readme():
    ...
    with patch('awslabs.cdk_mcp_server.data.genai_cdk_loader._readme_cache', mock_cache), \
         patch('awslabs.cdk_mcp_server.data.genai_cdk_loader.httpx.AsyncClient') as mock_client_factory:
...
async def test_list_sections_success():
    ...
    with patch('awslabs.cdk_mcp_server.data.genai_cdk_loader.fetch_readme', 
         ...
         patch('awslabs.cdk_mcp_server.data.genai_cdk_loader.extract_sections',
               return_value=test_sections) as mock_extract:
...
async def test_list_sections_error():
    ...
    with patch('awslabs.cdk_mcp_server.data.genai_cdk_loader._sections_cache', mock_cache), \
         patch('awslabs.cdk_mcp_server.data.genai_cdk_loader.fetch_readme', 
               new=AsyncMock()) as mock_fetch_readme:
...
async def test_get_section_success():
    ...
    with patch('awslabs.cdk_mcp_server.data.genai_cdk_loader._sections_cache', {}), \
         patch('awslabs.cdk_mcp_server.data.genai_cdk_loader.fetch_readme',
              new=AsyncMock()) as mock_fetch_readme, \
         patch('awslabs.cdk_mcp_server.data.genai_cdk_loader.extract_sections',
              return_value=test_sections) as mock_extract:
...
async def test_fetch_repo_structure():
    ...
    mock_response.json.return_value = [
        {"name": "bedrock", "type": "dir", "path": "src/cdk-lib/bedrock", "html_url": "https://github.com/url"},
        {"name": "opensearch", "type": "dir", "path": "src/cdk-lib/opensearch", "html_url": "https://github.com/url"}
    ]
...
async def test_fetch_bedrock_subdirectories():
    ...
    mock_dirs_response = [
        {"name": "agents", "type": "dir", "path": "src/cdk-lib/bedrock/agents", "html_url": "https://github.com/url"},
        {"name": "kb", "type": "dir", "path": "src/cdk-lib/bedrock/kb", "html_url": "https://github.com/url"}
    ]
    ...
    with patch('httpx.AsyncClient', return_value=mock_context), \
         patch('awslabs.cdk_mcp_server.data.genai_cdk_loader.fetch_readme',
              return_value=mock_readme_response, new_callable=AsyncMock):
...
async def test_list_available_constructs():
    ...
    with patch('awslabs.cdk_mcp_server.data.genai_cdk_loader.fetch_repo_structure',
              new=AsyncMock()) as mock_fetch_structure, \
         patch('awslabs.cdk_mcp_server.data.genai_cdk_loader.fetch_readme',
              new=AsyncMock()) as mock_fetch_readme, \
         patch('awslabs.cdk_mcp_server.data.genai_cdk_loader.extract_sections',
