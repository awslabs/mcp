...
def register_tools(mcp: FastMCP):
    ...
    async def create_domain(
        ...
        domain_execution_role: str = Field(
            ..., description='The ARN of the domain execution role'
        ),
        service_role: str = Field(..., description='The ARN of the service role'),
        domain_version: str = Field(
            default='V2', description='The version of the domain (V1 or V2)'
        ),
        description: Optional[str] = Field(default=None, description='Description of the domain'),
        kms_key_identifier: Optional[str] = Field(
            default=None, description='ARN of the KMS key for encryption'
        ),
        tags: Optional[Dict[str, str]] = Field(
            default=None, description='Tags to associate with the domain'
        ),
        single_sign_on: Optional[Dict[str, str]] = Field(
            default=None, description='Single sign-on configuration'
        ),
    ) -> Dict[str, Any]:
    ...
    async def list_domains(
        max_results: int = Field(
            default=25, description='Maximum number of results to return (max: 25)'
        ),
    ...
    async def create_domain_unit(
        ...
        description: Optional[str] = Field(
            default=None, description='Description of the domain unit'
        ),
    ...
    async def search(
        ...
        additional_attributes: Optional[List[str]] = Field(
            default=None, description='Additional attributes to include'
        ),
        filters: Optional[Dict[str, Any]] = Field(
            default=None, description='Filters to apply to the search'
        ),
        ...
        owning_project_identifier: Optional[str] = Field(
            default=None, description='The identifier of the owning project'
        ),
