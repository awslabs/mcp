...
class TestTypeDefinitions:
    ...
    def test_type_definitions(self):
        ...
        assert clients.AgentsforBedrockClient == object
        assert clients.AgentsforBedrockRuntimeClient == object
        ...
        with patch.dict('sys.modules', {
            ...
            with patch('typing.TYPE_CHECKING', True):
                ...
                try:
                    ...
                    importlib.reload(awslabs.bedrock_kb_retrieval_mcp_server.knowledgebases.clients)
                except Exception:
