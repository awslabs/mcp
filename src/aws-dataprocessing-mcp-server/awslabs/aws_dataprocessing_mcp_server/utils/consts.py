...
TABLE_TYPE_PARAMETER_KEY = 'table_type'
ICEBERG_TABLE_TYPE_VALUE = 'ICEBERG'
DELTA_TABLE_TYPE_VALUE = 'DELTA'
ICEBERG_METADATA_LOCATION_PARAMETER_KEY = 'metadata_location'
ICEBERG_PREVIOUS_METADATA_LOCATION_PARAMETER_KEY = 'previous_metadata_location'
ICEBERG_FORMAT_VERSION_PARAMETER_KEYS = ('format-version', 'write.format.version')
DELTA_PARAMETER_PREFIX = 'delta.'
HUDI_PARAMETER_PREFIX = 'hoodie.'
TABLE_FORMAT_HIVE = 'HIVE'
TABLE_FORMAT_ICEBERG = 'ICEBERG'
TABLE_FORMAT_DELTA = 'DELTA'
TABLE_FORMAT_HUDI = 'HUDI'
TABLE_FORMAT_UNKNOWN = 'UNKNOWN'
