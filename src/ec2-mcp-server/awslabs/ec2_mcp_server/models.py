...
class Instance(BaseModel):
    ...
    instance_id: str = Field(..., description='Instance ID', pattern=r'^i-[a-f0-9]{8,17}$')
    instance_type: str = Field(..., description='Instance type', min_length=1, max_length=20)
    state: InstanceStateModel = Field(..., description='Instance state')
    image_id: str = Field(..., description='AMI ID', pattern=r'^ami-[a-f0-9]{8,17}$')
    key_name: Optional[str] = Field(None, description='Key pair name')
    subnet_id: Optional[str] = Field(
        None, description='Subnet ID', pattern=r'^subnet-[a-f0-9]{8,17}$'
    )
    vpc_id: Optional[str] = Field(None, description='VPC ID', pattern=r'^vpc-[a-f0-9]{8,17}$')
    ...
    security_groups: List[SecurityGroup] = Field(
        default_factory=list, description='Attached security groups'
    )
...
class IpPermission(BaseModel):
    ...
    ip_ranges: List[Dict[str, str]] = Field(default_factory=list, description='IPv4 CIDR blocks')
    ipv6_ranges: List[Dict[str, str]] = Field(default_factory=list, description='IPv6 CIDR blocks')
    user_id_group_pairs: List[Dict[str, Any]] = Field(
        default_factory=list, description='Referenced security groups'
    )
...
class SecurityGroupDetail(BaseModel):
    ...
    ip_permissions: List[IpPermission] = Field(default_factory=list, description='Inbound rules')
    ip_permissions_egress: List[IpPermission] = Field(
        default_factory=list, description='Outbound rules'
    )
    tags: List[Tag] = Field(default_factory=list, description='Resource tags')
...
class KeyPair(BaseModel):
    ...
    key_name: str = Field(..., description='Key pair name', min_length=1, max_length=255)
...
class Volume(BaseModel):
    ...
    volume_id: str = Field(..., description='Volume ID', pattern=r'^vol-[a-f0-9]{8,17}$')
...
class Snapshot(BaseModel):
    ...
    snapshot_id: str = Field(..., description='Snapshot ID', pattern=r'^snap-[a-f0-9]{8,17}$')
    volume_id: Optional[str] = Field(
        None, description='Source volume ID', pattern=r'^vol-[a-f0-9]{8,17}$'
    )
...
class Vpc(BaseModel):
    ...
    vpc_id: str = Field(..., description='VPC ID', pattern=r'^vpc-[a-f0-9]{8,17}$')
...
class Subnet(BaseModel):
    ...
    subnet_id: str = Field(..., description='Subnet ID', pattern=r'^subnet-[a-f0-9]{8,17}$')
    vpc_id: str = Field(..., description='VPC ID', pattern=r'^vpc-[a-f0-9]{8,17}$')
    cidr_block: str = Field(..., description='CIDR block')
    availability_zone: str = Field(..., description='Availability zone')
