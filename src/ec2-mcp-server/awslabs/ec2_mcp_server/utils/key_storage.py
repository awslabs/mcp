...
class KeyStorageManager:
    ...
    async def store_private_key(
        self, key_name: str, private_key_material: str, storage_method: str, **kwargs
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if storage_method == 'secrets_manager':
                return await self._store_in_secrets_manager(
                    key_name, private_key_material, **kwargs
                )
                ...
                return await self._store_in_parameter_store(
                    key_name, private_key_material, **kwargs
                )
            else:
            ...
            return {'status': 'error', 'message': f'Failed to store private key: {str(e)}'}

    async def delete_stored_key(
        self, key_name: str, storage_method: str, storage_location: str
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return {'status': 'error', 'message': f'Failed to delete stored key: {str(e)}'}
    ...
    async def _store_in_s3_encrypted(
        self, key_name: str, private_key_material: str, tags: Optional[Dict[str, str]] = None
    ) -> Dict[str, Any]:
    ...
    async def _ensure_s3_bucket_exists(
        self, bucket_name: str, is_default_bucket: bool = False
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                logger.debug(
                    f'S3 head_bucket error: {head_error}, error_code: {error_code}, is_no_such_bucket: {is_no_such_bucket}'
                )
            ...
            return {'status': 'error', 'message': f'S3 bucket check failed: {str(e)}'}
