...
aws_client = AWSClientManager(
    region=config.get('aws_region', 'us-east-1'), profile=config.get('aws_profile')
)
...
async def list_amis(
    ...
    try:
        ...
        sorted_amis = sorted(
            response['Images'], key=lambda x: x.get('CreationDate', ''), reverse=True
        )
    ...
    try:
        ...
        try:
            ...
            if al2023_response['Images']:
                ami = sorted(
                    al2023_response['Images'], key=lambda x: x['CreationDate'], reverse=True
                )[0]
                popular_amis.append(
                    {
        ...
        try:
            ...
            if ubuntu_response['Images']:
                ami = sorted(
                    ubuntu_response['Images'], key=lambda x: x['CreationDate'], reverse=True
                )[0]
                popular_amis.append(
                    {
                        'category': 'Ubuntu',
        ...
        try:
            ...
            if windows_response['Images']:
                ami = sorted(
                    windows_response['Images'], key=lambda x: x['CreationDate'], reverse=True
                )[0]
                popular_amis.append(
                    {
        ...
        try:
            ...
            if al2_response['Images']:
                ami = sorted(
                    al2_response['Images'], key=lambda x: x['CreationDate'], reverse=True
                )[0]
                popular_amis.append(
                    {
                        'category': 'Amazon Linux',
        ...
        try:
            ...
            if rhel_response['Images']:
                ami = sorted(
                    rhel_response['Images'], key=lambda x: x['CreationDate'], reverse=True
                )[0]
                popular_amis.append(
                    {
