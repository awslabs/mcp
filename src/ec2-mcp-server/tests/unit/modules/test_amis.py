...
class TestListAmis:
    ...
    async def test_list_amis_default_behavior(self, mock_aws_client, mock_ami_data):
        ...
        mock_client.describe_images.return_value = {'Images': [mock_ami_data]}
    ...
    async def test_get_popular_amis_with_exception_handling(self, mock_aws_client):
        ...
        def mock_describe_images(**kwargs):
            if 'al2023-ami-' in str(kwargs.get('Filters', [])):
                raise ClientError(
                    error_response={
                        'Error': {'Code': 'RequestLimitExceeded', 'Message': 'Rate limit exceeded'}
                    },
...
class TestCreateImage:
    ...
    async def test_create_image_general_exception(self, mock_validate, mock_aws_client):
        ...
        result = await create_image(instance_id='i-1234567890abcdef0', name='test-ami')
...
class TestRegisterModule:
    ...
    def test_register_module(self):
        ...
        expected_tools = ['list_amis', 'get_popular_amis', 'create_image', 'deregister_image']
