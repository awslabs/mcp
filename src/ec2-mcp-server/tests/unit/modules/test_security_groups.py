...
class TestListSecurityGroups:
    ...
    @patch('awslabs.ec2_mcp_server.modules.security_groups.aws_client')
    @pytest.mark.asyncio
    async def test_list_security_groups_with_filters(
        self, mock_aws_client, mock_security_group_data
    ):
        ...
        result = await list_security_groups(
            group_ids=group_ids, group_names=group_names, filters=filters
        )
...
class TestGetSecurityGroupDetails:
    ...
    @pytest.mark.asyncio
    async def test_get_security_group_details_success(
        self, mock_validate, mock_aws_client, mock_security_group_data
    ):
    ...
    @patch('awslabs.ec2_mcp_server.modules.security_groups.aws_client')
    @pytest.mark.asyncio
    async def test_get_security_group_details_general_exception(
...
class TestCreateSecurityGroup:
    ...
    async def test_create_security_group_success(self, mock_validate, mock_aws_client):
        ...
        mock_client.create_security_group.assert_called_once_with(
            GroupName='test-sg', Description='Test security group', VpcId='vpc-12345678'
        )
    ...
    async def test_create_security_group_without_tags(self, mock_validate, mock_aws_client):
        ...
        result = await create_security_group(
            group_name='test-sg', description='Test security group', vpc_id='vpc-12345678'
        )
...
class TestModifySecurityGroupRules:
    ...
    @patch('awslabs.ec2_mcp_server.modules.security_groups.validate_security_group_id')
    @pytest.mark.asyncio
    async def test_modify_security_group_rules_remove_outbound(
        self, mock_validate, mock_aws_client
    ):
    ...
    @patch('awslabs.ec2_mcp_server.modules.security_groups.validate_security_group_id')
    @pytest.mark.asyncio
    async def test_modify_security_group_rules_with_source_sg(
        self, mock_validate, mock_aws_client
    ):
    ...
    async def test_modify_security_group_rules_invalid_action(self):
        ...
        result = await modify_security_group_rules(
            group_id='sg-12345678', action='invalid', rule_type='inbound', ip_protocol='tcp'
        )
    ...
    async def test_modify_security_group_rules_invalid_rule_type(self):
        ...
        result = await modify_security_group_rules(
            group_id='sg-12345678', action='add', rule_type='invalid', ip_protocol='tcp'
        )
    ...
    @patch('awslabs.ec2_mcp_server.modules.security_groups.validate_security_group_id')
    @pytest.mark.asyncio
    async def test_modify_security_group_rules_remove_inbound(
        self, mock_validate, mock_aws_client
    ):
    ...
    @patch('awslabs.ec2_mcp_server.modules.security_groups.aws_client')
    @pytest.mark.asyncio
    async def test_modify_security_group_rules_general_exception(
        self, mock_aws_client, mock_validate
    ):
        ...
        result = await modify_security_group_rules(
            group_id='sg-12345678', action='add', rule_type='inbound', ip_protocol='tcp'
        )
