...
class TestListVolumes:
    ...
    async def test_list_volumes_success(self, mock_aws_client, mock_volume_data):
        ...
        mock_client.describe_volumes.return_value = {'Volumes': [mock_volume_data]}
    ...
    async def test_list_volumes_with_both_params(self, mock_aws_client, mock_volume_data):
        ...
        assert result['status'] == 'success'
        mock_client.describe_volumes.assert_called_once_with(VolumeIds=volume_ids, Filters=filters)
    ...
    async def test_list_volumes_with_missing_optional_fields(self, mock_aws_client):
        ...
        mock_client = MagicMock()
        mock_aws_client.get_client.return_value = mock_client
        mock_client.describe_volumes.return_value = {'Volumes': [volume_data]}
...
class TestCreateVolume:
    ...
    @patch('awslabs.ec2_mcp_server.modules.volumes.aws_client')
    @pytest.mark.asyncio
    async def test_create_volume_minimal_params(
        self, mock_aws_client, mock_create_volume_response
    ):
        ...
        result = await create_volume(availability_zone='us-east-1a', size=20)
    ...
    @patch('awslabs.ec2_mcp_server.modules.volumes.aws_client')
    @pytest.mark.asyncio
    async def test_create_volume_with_custom_type(
        self, mock_aws_client, mock_create_volume_response
    ):
        ...
        result = await create_volume(availability_zone='us-east-1a', size=100, volume_type='io2')
    ...
    async def test_create_volume_with_iops(self, mock_aws_client, mock_create_volume_response):
        ...
        result = await create_volume(
            availability_zone='us-east-1a', size=100, volume_type='io2', iops=1000
        )
    ...
    @patch('awslabs.ec2_mcp_server.modules.volumes.aws_client')
    @pytest.mark.asyncio
    async def test_create_volume_with_throughput(
        self, mock_aws_client, mock_create_volume_response
    ):
        ...
        result = await create_volume(
            availability_zone='us-east-1a', size=100, volume_type='gp3', throughput=250
        )
    ...
    async def test_create_volume_encrypted(self, mock_aws_client, mock_create_volume_response):
        ...
        result = await create_volume(availability_zone='us-east-1a', size=20, encrypted=True)
    ...
    async def test_create_volume_with_tags(self, mock_aws_client, mock_create_volume_response):
        ...
        result = await create_volume(availability_zone='us-east-1a', size=20, tags=tags)
    ...
    @patch('awslabs.ec2_mcp_server.modules.volumes.aws_client')
    @pytest.mark.asyncio
    async def test_create_volume_with_all_params(
        self, mock_aws_client, mock_create_volume_response
    ):
...
class TestAttachVolume:
    ...
    @patch('awslabs.ec2_mcp_server.modules.volumes.aws_client')
    @pytest.mark.asyncio
    async def test_attach_volume_success(
        self,
        mock_aws_client,
        mock_validate_volume,
        mock_validate_instance,
        mock_attach_volume_response,
    ):
        ...
        result = await attach_volume(
            volume_id='vol-1234567890abcdef0', instance_id='i-1234567890abcdef0', device='/dev/sdf'
        )
        ...
        mock_client.attach_volume.assert_called_once_with(
            VolumeId='vol-1234567890abcdef0', InstanceId='i-1234567890abcdef0', Device='/dev/sdf'
        )
    ...
    @patch('awslabs.ec2_mcp_server.modules.volumes.aws_client')
    @pytest.mark.asyncio
    async def test_attach_volume_client_error(
        self, mock_aws_client, mock_validate_volume, mock_validate_instance
    ):
        ...
        mock_client.attach_volume.side_effect = ClientError(
            error_response={
                'Error': {'Code': 'VolumeInUse', 'Message': 'Volume already attached'}
            },
...
class TestDetachVolume:
    ...
    @patch('awslabs.ec2_mcp_server.modules.volumes.aws_client')
    @pytest.mark.asyncio
    async def test_detach_volume_minimal_params(
        self, mock_aws_client, mock_validate, mock_detach_volume_response
    ):
    ...
    @patch('awslabs.ec2_mcp_server.modules.volumes.aws_client')
    @pytest.mark.asyncio
    async def test_detach_volume_with_instance_id(
        self, mock_aws_client, mock_validate, mock_detach_volume_response
    ):
        ...
        result = await detach_volume(
            volume_id='vol-1234567890abcdef0', instance_id='i-1234567890abcdef0'
        )
    ...
    @patch('awslabs.ec2_mcp_server.modules.volumes.aws_client')
    @pytest.mark.asyncio
    async def test_detach_volume_with_device(
        self, mock_aws_client, mock_validate, mock_detach_volume_response
    ):
        ...
        result = await detach_volume(volume_id='vol-1234567890abcdef0', device='/dev/sdf')
    ...
    @patch('awslabs.ec2_mcp_server.modules.volumes.aws_client')
    @pytest.mark.asyncio
    async def test_detach_volume_with_force(
        self, mock_aws_client, mock_validate, mock_detach_volume_response
    ):
        ...
        result = await detach_volume(volume_id='vol-1234567890abcdef0', force=True)
    ...
    @patch('awslabs.ec2_mcp_server.modules.volumes.aws_client')
    @pytest.mark.asyncio
    async def test_detach_volume_with_all_params(
        self, mock_aws_client, mock_validate, mock_detach_volume_response
    ):
