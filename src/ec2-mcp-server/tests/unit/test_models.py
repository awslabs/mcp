...
class TestBasicModels:
    ...
    def test_placement_model(self):
        ...
        placement_data = {'availability_zone': 'us-east-1a', 'tenancy': 'default'}
...
class TestKeyPairModel:
    ...
    def test_key_pair_complete(self):
        ...
        assert 'BEGIN TEST RSA PRIVATE KEY' in key_pair.key_material  # pragma: allowlist secret
