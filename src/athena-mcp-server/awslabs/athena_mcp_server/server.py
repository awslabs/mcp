...
mcp = FastMCP(
    ...
    instructions='AWS Athena MCP Server provides tools to execute SQL queries against data stored in Amazon S3 using AWS Athena.',
    dependencies=[
        'pydantic',
        'loguru',
    ],
...
async def example_tool(
    ...
    """
    project_name = 'awslabs Athena MCP Server'
    return (
