...
from awslabs.athena_mcp_server.server import main
...
class TestMain:
    ...
    @patch('awslabs.athena_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.athena-mcp-server'])
    ...
    def test_module_execution(self):
        ...
        import inspect
        from awslabs.athena_mcp_server import server
