...
class TestToolExceptionHandling:
    ...
    async def test_list_metrics_exception(self):
        ...
        with patch('awslabs.prometheus_mcp_server.server.configure_workspace_for_request', 
    ...
    async def test_get_available_workspaces_exception(self):
        ...
        with patch('awslabs.prometheus_mcp_server.server.get_prometheus_client', 
                   side_effect=Exception('Test error')):
...
class TestMainExecution:
    ...
    def test_main_execution(self):
        ...
        with patch('awslabs.prometheus_mcp_server.server.ConfigManager.parse_arguments') as mock_args, \
