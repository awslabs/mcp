...
def test_load_prompt_templates_with_missing_file():
    ...
    with mock.patch("awslabs.aws_wa_sec_tool_mcp_server.util.prompt_utils._is_initialized", False):
...
"""
    ...
    try:
        ...
        with mock.patch(
            "awslabs.aws_wa_sec_tool_mcp_server.util.prompt_utils._is_initialized", False
        ):
            with mock.patch(
                "awslabs.aws_wa_sec_tool_mcp_server.util.prompt_utils._prompt_templates", {}
            ):
...
def test_get_prompt_template_existing():
    ...
    with mock.patch(
        "awslabs.aws_wa_sec_tool_mcp_server.util.prompt_utils._prompt_templates", mock_templates
    ):
        with mock.patch(
            "awslabs.aws_wa_sec_tool_mcp_server.util.prompt_utils._is_initialized", True
        ):
...
def test_get_prompt_template_nonexistent():
    ...
    with mock.patch("awslabs.aws_wa_sec_tool_mcp_server.util.prompt_utils._prompt_templates", {}):
        with mock.patch(
            "awslabs.aws_wa_sec_tool_mcp_server.util.prompt_utils._is_initialized", True
        ):
