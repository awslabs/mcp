...
from awslabs.aws_wa_sec_tool_mcp_server.util.resource_utils import (
    USER_AGENT_CONFIG as RESOURCE_USER_AGENT_CONFIG,
)
from awslabs.aws_wa_sec_tool_mcp_server.util.security_services import USER_AGENT_CONFIG
...
def test_user_agent_config_is_properly_configured():
    ...
    expected_user_agent = "awslabs/mcp/aws-wa-sec-tool-mcp-server/1.0.0"
...
async def test_storage_security_uses_user_agent_config():
    ...
    from awslabs.aws_wa_sec_tool_mcp_server.util.storage_security import find_storage_resources
...
async def test_network_security_uses_user_agent_config():
    ...
    from awslabs.aws_wa_sec_tool_mcp_server.util.network_security import find_network_resources
