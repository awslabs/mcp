...
async def test_check_storage_encryption_multiple_services(mock_ctx, mock_boto3_session):
    ...
    with mock.patch(
        ...
        with (
            ...
            mock.patch(
                "awslabs.aws_wa_sec_tool_mcp_server.util.storage_security.check_ebs_volumes"
            ) as mock_check_ebs,
            mock.patch(
                "awslabs.aws_wa_sec_tool_mcp_server.util.storage_security.check_rds_instances"
            ) as mock_check_rds,
            mock.patch(
                "awslabs.aws_wa_sec_tool_mcp_server.util.storage_security.check_dynamodb_tables"
...
async def test_check_storage_encryption_with_efs_and_elasticache(mock_ctx, mock_boto3_session):
    ...
    with mock.patch(
        ...
        with (
            mock.patch(
                "awslabs.aws_wa_sec_tool_mcp_server.util.storage_security.check_efs_filesystems"
            ) as mock_check_efs,
            mock.patch(
                "awslabs.aws_wa_sec_tool_mcp_server.util.storage_security.check_elasticache_clusters"
