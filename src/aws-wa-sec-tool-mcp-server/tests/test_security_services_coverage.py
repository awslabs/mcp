...
async def test_check_access_analyzer_with_await_exception(mock_ctx, mock_boto3_session):
    ...
    with mock.patch(
        "awslabs.aws_wa_sec_tool_mcp_server.util.security_services.get_analyzer_findings_count"
...
async def test_get_guardduty_findings_no_detector_id(mock_ctx, mock_boto3_session):
    ...
    from awslabs.aws_wa_sec_tool_mcp_server.util.security_services import get_guardduty_findings
