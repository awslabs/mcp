...
class TestSecurityInputValidation:
    ...
    @pytest.mark.parametrize('malicious_region', [
    ...
    @pytest.mark.parametrize('malicious_profile', [
    ...
    @pytest.mark.parametrize('malicious_core_network_id', [
    ...
    async def test_core_network_id_injection_prevention(self, mock_get_client, malicious_core_network_id):
        ...
        with pytest.raises(ToolError):
            await get_cloudwan_details(
                core_network_id=malicious_core_network_id,
    ...
    @pytest.mark.parametrize('oversized_input', [
    ...
    async def test_aws_credentials_not_leaked_in_errors(self, mock_get_client):
        ...
        sensitive_patterns = [
            ...
            'akia', 'key_id', 'secret_key'
        ]

        for pattern in sensitive_patterns:
            assert pattern not in error_msg, f"Potentially sensitive data found in error: {pattern}"
