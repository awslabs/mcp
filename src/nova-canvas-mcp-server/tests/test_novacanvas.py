...
class TestInvokeNovaCanvas:
    ...
    @pytest.mark.asyncio
    async def test_successful_invocation(self, mock_bedrock_runtime_client, mock_successful_response):
...
class TestGenerateImageWithText:
    ...
    async def test_successful_generation(
        self, mock_save_images, mock_invoke_nova_canvas, 
        mock_bedrock_runtime_client, sample_text_prompt, temp_workspace_dir
    ):
        """Test successful image generation with text."""
        # Set up mocks
        mock_invoke_nova_canvas.return_value = {
    ...
    async def test_generation_with_negative_prompt(
        self, mock_save_images, mock_invoke_nova_canvas, 
        mock_bedrock_runtime_client, sample_text_prompt, sample_negative_prompt, temp_workspace_dir
    ):
    ...
    async def test_validation_error(
        self, mock_invoke_nova_canvas, mock_bedrock_runtime_client
    ):
    ...
    async def test_default_parameters(
        self, mock_save_images, mock_invoke_nova_canvas, 
        mock_bedrock_runtime_client, sample_text_prompt
    ):
...
class TestGenerateImageWithColors:
    ...
    async def test_successful_generation(
        self, mock_save_images, mock_invoke_nova_canvas, 
        mock_bedrock_runtime_client, sample_text_prompt, sample_colors, temp_workspace_dir
    ):
    ...
    async def test_generation_with_negative_prompt(
        self, mock_save_images, mock_invoke_nova_canvas, 
        mock_bedrock_runtime_client, sample_text_prompt, sample_colors, sample_negative_prompt, temp_workspace_dir
    ):
    ...
    @patch('awslabs.nova_canvas_mcp_server.novacanvas.invoke_nova_canvas')
    async def test_api_error(
        self, mock_invoke_nova_canvas, mock_bedrock_runtime_client, sample_text_prompt, sample_colors
    ):
        """Test handling of API errors."""
        # Set up the mock to raise an exception
        mock_invoke_nova_canvas.side_effect = Exception("API error")
    ...
    async def test_default_parameters(
        self, mock_save_images, mock_invoke_nova_canvas, 
        mock_bedrock_runtime_client, sample_text_prompt, sample_colors
    ):
        """Test image generation with default parameters."""
        # Set up mocks
        mock_invoke_nova_canvas.return_value = {
