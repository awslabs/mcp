...
# ===========================================================================
# _is_primitive_enabled() tests
# ===========================================================================


class TestIsPrimitiveEnabled:
    """Tests for _is_primitive_enabled() env var parsing."""
    ...
    def test_default_no_env_vars(self, monkeypatch):
        ...
        from awslabs.amazon_bedrock_agentcore_mcp_server.server import _is_primitive_enabled

        assert _is_primitive_enabled('browser') is True
        assert _is_primitive_enabled('runtime') is True
    ...
    def test_disable_browser(self, monkeypatch):
        ...
        assert _is_primitive_enabled('browser') is False
        assert _is_primitive_enabled('runtime') is True
    ...
    def test_enable_browser_only(self, monkeypatch):
        ...
        assert _is_primitive_enabled('browser') is True
        assert _is_primitive_enabled('runtime') is False
