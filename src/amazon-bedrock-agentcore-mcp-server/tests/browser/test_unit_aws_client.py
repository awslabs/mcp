...
from awslabs.amazon_bedrock_agentcore_mcp_server.tools.browser.aws_client import (
...
PATCH_BROWSER_CLIENT = (
    'awslabs.amazon_bedrock_agentcore_mcp_server.tools.browser.aws_client.BrowserClient'
)
