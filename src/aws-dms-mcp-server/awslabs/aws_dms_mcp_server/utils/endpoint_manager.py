...
class EndpointManager:
    ...
    def list_endpoints(
        ...
        formatted_endpoints = [
            ResponseFormatter.format_endpoint(endpoint)
    ...
    def create_endpoint(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        required_params = [
            ...
            "ServerName", "Port", "DatabaseName", "Username"
        ]
    ...
    def validate_endpoint_config(self, config: Dict[str, Any]) -> Tuple[bool, str]:
        ...
        supported_engines = [
            "mysql", "postgres", "postgresql", "oracle", "sqlserver",
            "mariadb", "aurora", "aurora-postgresql", "redshift",
            "s3", "dynamodb", "mongodb", "sybase", "db2", "azuredb"
        ]
        ...
        if port and default_ports and port != default_ports:
            logger.warning(f"Non-standard port {port} for engine {engine} (default: {default_ports})")
    ...
    def get_engine_settings(self, engine: str) -> Dict[str, Any]:
        ...
        return engine_defaults.get(engine, {
            "default_port": None,
            "ssl_supported": False,
            "requires_server_name": True
        })
