...
class ServerlessManager:
    ...
    def create_migration_project(
        ...
        if schema_conversion_application_attributes:
            params["SchemaConversionApplicationAttributes"] = schema_conversion_application_attributes
        if tags:
            params["Tags"] = tags
    ...
    def modify_migration_project(
        ...
        return {
            "success": True,
            "data": {"migration_project": project, "message": "Migration project modified successfully"},
            "error": None
        }
    ...
    def delete_migration_project(self, arn: str) -> Dict[str, Any]:
        ...
        return {
            "success": True,
            "data": {"migration_project": project, "message": "Migration project deleted successfully"},
            "error": None
        }
    ...
    def create_instance_profile(
        ...
        return {
            "success": True,
            "data": {"instance_profile": profile, "message": "Instance profile created successfully"},
            "error": None
        }
    ...
    def modify_instance_profile(
        ...
        return {
            "success": True,
            "data": {"instance_profile": profile, "message": "Instance profile modified successfully"},
            "error": None
        }
    ...
    def delete_instance_profile(self, arn: str) -> Dict[str, Any]:
        ...
        return {
            "success": True,
            "data": {"instance_profile": profile, "message": "Instance profile deleted successfully"},
            "error": None
        }
    ...
    def create_data_migration(
        ...
        return {
            "success": True,
            "data": {"data_migration": migration, "message": "Data migration created successfully"},
            "error": None
        }
    ...
    def modify_data_migration(
        ...
        return {
            "success": True,
            "data": {"data_migration": migration, "message": "Data migration modified successfully"},
            "error": None
        }
    ...
    def delete_data_migration(self, arn: str) -> Dict[str, Any]:
        ...
        return {
            "success": True,
            "data": {"data_migration": migration, "message": "Data migration deleted successfully"},
            "error": None
        }
    ...
    def start_data_migration(self, arn: str, start_type: str) -> Dict[str, Any]:
        ...
        return {
            "success": True,
            "data": {"data_migration": migration, "message": f"Data migration started with type: {start_type}"},
            "error": None
        }
