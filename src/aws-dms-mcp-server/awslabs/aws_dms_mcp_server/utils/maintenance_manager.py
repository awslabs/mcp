...
class MaintenanceManager:
    ...
    def apply_pending_maintenance_action(
        ...
        """
        logger.info("Applying pending maintenance action", resource_arn=resource_arn, action=apply_action)
    ...
    def remove_tags(
        ...
        Returns:
            Operation result
        """
        logger.info("Removing tags from resource", resource_arn=resource_arn, key_count=len(tag_keys))
