...
### Step 2: Add ADOT Node.js Lambda Layer

Use the layer name `AWSOpenTelemetryDistroJs` and select the appropriate ARN from the region-specific list above. Only add the one necessary Layer ARN from the list above, like the examples below.
