# Enable Application Signals for Java Applications on Amazon EKS
...
Modify your deployment manifest to include the Java instrumentation annotation:
...
Update the Kubernetes deployment to include the Java instrumentation annotation:
...
2. Apply the changes:
   ...
   terraform plan -var-file="config/java-springboot.tfvars"
   terraform apply -var-file="config/java-springboot.tfvars"
   ```
