...
class TestListChangeEventsErrorHandling:
    ...
    async def test_no_credentials_error(self, mock_aws_clients):
        ...
        mock_aws_clients['applicationsignals_client'].list_entity_events.side_effect = NoCredentialsError()
    ...
    async def test_generic_exception_handling(self, mock_aws_clients):
        ...
        mock_aws_clients['applicationsignals_client'].list_entity_events.side_effect = Exception("Unexpected error")
...
class TestListChangeEventsPagination:
    ...
    async def test_pagination_with_next_token(self, mock_aws_clients):
        ...
        second_call_args = mock_aws_clients['applicationsignals_client'].list_entity_events.call_args_list[1][1]
...
class TestListChangeEventsEdgeCases:
    ...
    async def test_response_structure_completeness(self, mock_aws_clients):
        ...
        expected_fields = {
            "change_events", "next_token", "total_events", "events_by_type"
        }
...
class TestListChangeEventsToolFunctionality:
    ...
    async def test_integration_both_api_paths(self, mock_aws_clients):
        ...
        states_response = {
            "ServiceStates": [
                {
                    "Service": {"Name": "test-service", "Environment": "eks:prod", "Platform": "EKS"},
                    "LatestChangeEvents": [
                        {
                            "EventId": "state-event-1",
                            "EventName": "ServiceUpdate",
        ...
        mock_aws_clients['applicationsignals_client'].list_entity_events.return_value = entity_response
        mock_aws_clients['applicationsignals_client'].list_service_states.return_value = states_response
...
class TestListChangeEventsWorkflowIntegration:
    ...
    async def test_multi_service_correlation_workflow(self, mock_aws_clients):
        ...
        mock_response = {
            "ServiceStates": [
                {
                    "Service": {"Name": "database-service", "Environment": "prod", "Platform": "RDS"},
                    "LatestChangeEvents": [
                        {
                            "EventId": "db-change-1",
