...
> [!TIP]
> This MCP server is superseded by the official AWS MCP server. Check out the [migration guide](https://github.com/awslabs/mcp/blob/main/src/aws-api-mcp-server/MIGRATION.md) on how to move your configuration over!
