...
from awslabs.msk_mcp_server.server import main
...
class TestMain:
    ...
    @patch('awslabs.msk_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.msk-mcp-server'])
    ...
    @patch('awslabs.msk_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.msk-mcp-server', '--sse', '--port', '9999'])
    def test_main_sse(self, mock_run):
        ...
        from awslabs.msk_mcp_server.server import mcp
    ...
    def test_module_execution(self):
        ...
        import inspect
        from awslabs.msk_mcp_server import server
