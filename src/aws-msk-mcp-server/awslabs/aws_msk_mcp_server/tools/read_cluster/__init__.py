...
def register_module(mcp: FastMCP) -> None:
    @mcp.tool(name='describe_cluster_operation', description='Gets information about a cluster operation.')
    ...
    @mcp.tool(name='get_cluster_info', description='Gets comprehensive information about MSK clusters.')
