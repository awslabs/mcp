...
def update_security(
    ...
    Args:
            ...
            Example: {
                ...
                "Tls": {
                    "CertificateAuthorityArnList": [
                        "arn:aws:acm-pca:us-east-1:<account-id>:certificate-authority/abcdef12-3456-7890-abcd-ef1234567890"  # pragma: allowlist secret
                    ],
                    "Enabled": True
                },
                "Unauthenticated": {
        ...
        encryption_info (dict, optional): Includes all encryption-related information
            Example: {
                "EncryptionAtRest": {
                    "DataVolumeKMSKeyId": "arn:aws:kms:us-east-1:<account-id>:key/abcd1234-ab12-cd34-ef56-abcdef123456"  # pragma: allowlist secret
                },
                "EncryptionInTransit": {
                    "ClientBroker": "TLS",
                    "InCluster": True
