...
def register_module(mcp: FastMCP) -> None:
    ...
    def create_cluster_tool(
        ...
        Args:
            cluster_name (str): Name of the cluster (must be 1-64 characters, alphanumeric and hyphens only)
        ...
        Note:
            After creating a cluster, follow up with a tag_resource tool call
    ...
    @mcp.tool(name='update_broker_storage', description='Updates broker storage size in an MSK cluster.')
    def update_broker_storage_tool(
        ...
        Args:
            cluster_arn (str): Amazon Resource Name (ARN) that uniquely identifies the cluster
            current_version (str): Version of cluster to update from
        ...
        Note:
            ...
            Ensure resource has this tag before attempting to update it.
        """
        # Create a boto3 client
        client = boto3.client(
            'kafka',
    ...
    @mcp.tool(name='update_broker_type', description='Updates broker instance type in an MSK cluster.')
    ...
    @mcp.tool(name='update_cluster_configuration', description='Updates cluster configuration for an MSK cluster.')
    ...
    @mcp.tool(name='update_monitoring', description='Updates monitoring settings for an MSK cluster.')
    ...
    @mcp.tool(name='put_cluster_policy', description='Attaches a resource policy to an MSK cluster.')
    ...
    @mcp.tool(name='associate_scram_secret', description='Associates SCRAM secrets with an MSK cluster.')
    ...
    @mcp.tool(name='disassociate_scram_secret', description='Disassociates SCRAM secrets from an MSK cluster.')
