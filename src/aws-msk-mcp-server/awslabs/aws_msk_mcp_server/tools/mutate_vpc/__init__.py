...
def register_module(mcp: FastMCP) -> None:
    @mcp.tool(name='create_vpc_connection', description='Creates a VPC connection for an MSK cluster.')
    ...
    @mcp.tool(name='delete_vpc_connection', description='Deletes a VPC connection for an MSK cluster.')
    ...
    @mcp.tool(name='reject_client_vpc_connection', description='Rejects a client VPC connection request for an MSK cluster.')
