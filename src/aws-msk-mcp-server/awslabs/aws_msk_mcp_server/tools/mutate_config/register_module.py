...
def register_module(mcp: FastMCP) -> None:
    ...
    @mcp.tool(
        ...
        description="""Create a new MSK configuration with custom Kafka broker settings
...
- Only a subset of Kafka configuration properties are supported by MSK.""",
    ...
    @mcp.tool(
        ...
        description="""Create a new revision of an existing MSK configuration
...
- You must explicitly update clusters to use the new revision with the update_cluster_configuration tool.""",
    ...
    @mcp.tool(
        name='tag_resource',
        description="""Add key-value tags to an MSK resource
...
- The "MCP Generated" tag is used by this system to identify resources it can modify.""",
    ...
    @mcp.tool(
        name='untag_resource',
        description="""Remove specified tags from an MSK resource
