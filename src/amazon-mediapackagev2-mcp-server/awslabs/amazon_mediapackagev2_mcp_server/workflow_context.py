...
"""Self-contained cross-service workflow context tool for the MediaPackage V2 MCP server.

Each server in the aems_mcp repo carries an identical copy of this module
intentionally — no shared dependencies between servers. The text below
