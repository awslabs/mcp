...
"""MediaPackage V2 MCP Server — assembles generated code and overrides into a running FastMCP server.
...
import boto3
import botocore
from awslabs.amazon_mediapackagev2_mcp_server.consts import BOTO3_SERVICE_NAME
from awslabs.amazon_mediapackagev2_mcp_server.errors import (
    handle_client_error,
    handle_general_error,
)
from awslabs.amazon_mediapackagev2_mcp_server.overrides.descriptions import (
    FIELD_DESCRIPTION_OVERRIDES,
    TOOL_DESCRIPTION_OVERRIDES,
)
from awslabs.amazon_mediapackagev2_mcp_server.overrides.instructions import INSTRUCTIONS
from awslabs.amazon_mediapackagev2_mcp_server.overrides.tool_config import (
    DESTRUCTIVE_OPERATIONS,
    INCLUDED_OPERATIONS,
    PAGINATION_DEFAULTS,
    READ_ONLY_OPERATIONS,
)
from awslabs.amazon_mediapackagev2_mcp_server.overrides.validation import VALIDATORS
from awslabs.amazon_mediapackagev2_mcp_server.workflow_context import (
    TOOL_DESCRIPTION as WORKFLOW_TOOL_DESCRIPTION,
)
from awslabs.amazon_mediapackagev2_mcp_server.workflow_context import get_media_workflow_context
...
try:
    from awslabs.amazon_mediapackagev2_mcp_server import BOTOCORE_SOURCE_VERSION, models
    from awslabs.amazon_mediapackagev2_mcp_server.operations import OPERATIONS
...
try:
    from awslabs.amazon_mediapackagev2_mcp_server.waiter_config import WAITER_REGISTRY
except (ImportError, SyntaxError):  # pragma: no cover
    WAITER_REGISTRY = {}  # pragma: no cover

mcp = FastMCP('awslabs_mediapackagev2_mcp_server', instructions=INSTRUCTIONS)
