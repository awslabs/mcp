...
"""Abstract database connection interface for the RDS for Db2 MCP Server."""
...
class AbstractDBConnection(ABC):
    ...
    async def execute_query(
        ...
        Args:
            sql: The SQL query to execute (use ``?`` for positional bind parameters)
    ...
    def validate_sync(self) -> None:
        """Validate connectivity synchronously (used at startup).

        Concrete connections may override this with a lightweight probe.
        """
