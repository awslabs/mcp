...
def test_discover_clusters_at_startup_discovers_clusters(mock_aws_helper):
    ...
    try:
        ...
        mock_aws_helper.create_boto3_client_for_account_region.return_value = (
            mock_eks_client
        )
...
def test_discover_with_default_credentials_creates_minimal_config(mock_aws_helper):
    ...
    # Run discovery
    EKSDiscoveryHandler.discover_clusters_with_default_credentials()
