...
class TestAwsHelper:
    ...
    def test_assume_role_success(self, mock_boto3_client):
        ...
        mock_sts_client.assume_role.return_value = {
            'Credentials': {
                ...
                'SessionToken': 'AQoEXAMPLEH4aoAH0gNCAPyJxz4BlCFFxWNE1OPTgk5TthT+FvwqnKwRcOIfrRh3c',  # pragma: allowlist secret
    ...
    def test_assume_role_without_external_id(self, mock_boto3_client):
        ...
        with patch.object(AwsHelper, 'create_boto3_client', return_value=mock_sts_client):
            AwsHelper.assume_role(role_arn='arn:aws:iam::123456789012:role/TestRole')
    ...
    def test_create_boto3_client_for_account_region_with_profile(self, mock_boto3_client):
        ...
        account_config = AccountConfig(
            ...
            regions=['us-west-2'],
            profile='test-profile',  # pragma: allowlist secret
        )
        ...
        with patch('boto3.Session', return_value=mock_session):
            result = AwsHelper.create_boto3_client_for_account_region(
                ...
                service_name='eks',  # pragma: allowlist secret
            )
    ...
    def test_create_boto3_client_for_cluster(self, mock_boto3_client):
        ...
        # Create test cluster
        cluster = ClusterConfig(name='test-cluster', region='us-west-2', account_id='123456789012')
        ...
        with patch.object(
            AwsHelper,
            'create_boto3_client_for_account_region',
    ...
    def test_create_boto3_client_for_cluster_error(self):
        ...
        cluster = ClusterConfig(name='test-cluster', region='us-west-2', account_id='999999999999')
