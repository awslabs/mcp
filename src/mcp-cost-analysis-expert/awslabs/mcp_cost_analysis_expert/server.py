"""awslabs MCP Cost Analysis expert server implementation.
...
from awslabs.mcp_cost_analysis_expert.static.patterns import BEDROCK
...
mcp = FastMCP(
    name='awslabs.mcp_cost_analysis_expert.',
