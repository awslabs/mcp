"""Helper classes for awslabs Cost Analysis expert.
        ...
        if isinstance(pricing_data.get('data'), str):
            ...
            if not cost_factors:
                ...
                if 'lambda' in service_name.lower():
                    ...
                    cost_factors = ['Read and write throughput', 'Storage used', 'Data transfer']
                elif 's3' in service_name.lower():
                    cost_factors = ['Storage used', 'Requests made', 'Data transfer']
                else:
                    cost_factors = ['Usage volume', 'Resource allocation', 'Data transfer']
