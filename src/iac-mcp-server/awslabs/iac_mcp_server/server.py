...
def troubleshoot_deployment(
    ...
    if isinstance(result, dict):
        result["_instruction"] = f"ALWAYS include this CloudFormation console deeplink in your response: [View CloudTrail Events](https://console.aws.amazon.com/cloudformation/home?region={region}#/stacks/stackinfo?stackId={stack_name})"
...
def get_template_examples() -> str:
    ...
    context = {
        "template_examples_repository": {
            ...
            "categories": ["vpc", "ecs", "lambda", "rds", "s3", "alb", "api-gateway", "dynamodb", "ec2", "iam"]
        },
