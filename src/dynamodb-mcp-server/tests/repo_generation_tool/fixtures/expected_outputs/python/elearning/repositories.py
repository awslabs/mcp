...
class TenantCertificateRepository(BaseRepository[TenantCertificate]):
    ...
    def get_tenant_certificate(
        self, tenant_id: str, user_id: str, course_id: str, issued_date: str
    ...
    def issue_course_certificate(self, certificate: TenantCertificate) -> TenantCertificate | None:
        ...
        # item_dict = tenant_certificate.to_dict()
...
class TenantCourseRepository(BaseRepository[TenantCourse]):
    ...
    def update_course_details(
        self, tenant_id: str, course_id: str, updates: TenantCourse, update_value
    ) -> TenantCourse | None:
        ...
        # pk = TenantCourse.build_pk_for_lookup(pk_params)
        # sk = TenantCourse.build_sk_for_lookup(sk_params)
...
class TenantEnrollmentRepository(BaseRepository[TenantEnrollment]):
    ...
    def get_tenant_enrollment(
        self, tenant_id: str, user_id: str, course_id: str, enrollment_date: str
    ...
    def enroll_user_in_course(self, enrollment: TenantEnrollment) -> TenantEnrollment | None:
        ...
        #
        # Main Table PutItem Example:
        # item_dict = tenant_enrollment.to_dict()
        # response = self.table.put_item(Item=item_dict)
        pass
    ...
    def update_enrollment_progress(
        ...
        #
        # Main Table UpdateItem Example:
        # pk = TenantEnrollment.build_pk_for_lookup(pk_params)
        # sk = TenantEnrollment.build_sk_for_lookup(sk_params)
        # response = self.table.update_item(
        #     Key={'pk': pk, 'sk': sk},
        #     UpdateExpression='SET #attr = :val',
        #     ExpressionAttributeNames={'#attr': 'attribute_name'},
...
class TenantLessonRepository(BaseRepository[TenantLesson]):
    ...
    def get_tenant_lesson(
        self, tenant_id: str, course_id: str, lesson_order: str, lesson_id: str
    ) -> TenantLesson | None:
    ...
    def create_course_lesson(self, lesson: TenantLesson) -> TenantLesson | None:
        ...
        #
        # Main Table PutItem Example:
        # item_dict = tenant_lesson.to_dict()
        # response = self.table.put_item(Item=item_dict)
        pass
...
class TenantProgressRepository(BaseRepository[TenantProgress]):
    ...
    def get_tenant_progress(
        self, tenant_id: str, user_id: str, course_id: str, lesson_id: str, attempt_date: str
    ) -> TenantProgress | None:
    ...
    def record_lesson_progress(self, progress: TenantProgress) -> TenantProgress | None:
        ...
        #
        # Main Table PutItem Example:
        # item_dict = tenant_progress.to_dict()
        # response = self.table.put_item(Item=item_dict)
        pass
    ...
    def update_lesson_progress(
        ...
        #
        # Main Table UpdateItem Example:
        # pk = TenantProgress.build_pk_for_lookup(pk_params)
        # sk = TenantProgress.build_sk_for_lookup(sk_params)
        # response = self.table.update_item(
        #     Key={'pk': pk, 'sk': sk},
        #     UpdateExpression='SET #attr = :val',
        #     ExpressionAttributeNames={'#attr': 'attribute_name'},
...
class TenantUserRepository(BaseRepository[TenantUser]):
    ...
    def update_user_profile(
        self, tenant_id: str, user_id: str, updates: TenantUser, update_value
    ) -> TenantUser | None:
        ...
        #
        # Main Table UpdateItem Example:
        # pk = TenantUser.build_pk_for_lookup(pk_params)
        # sk = TenantUser.build_sk_for_lookup(sk_params)
        # response = self.table.update_item(
        #     Key={'pk': pk, 'sk': sk},
        #     UpdateExpression='SET #attr = :val',
        #     ExpressionAttributeNames={'#attr': 'attribute_name'},
