...
class CommentRepository(BaseRepository[Comment]):
    ...
    def get_post_comments(
        ...
        # pk = Comment.build_pk_for_lookup(user_id)
        # query_params = {
        #     'KeyConditionExpression': Key('user_id').eq(pk) & Key('sort_key').eq(sk),
        #     'Limit': limit
        # }
...
class FollowRepository(BaseRepository[Follow]):
    ...
    def follow_user(self, follow: Follow) -> Follow | None:
        ...
        #
        # Main Table PutItem Example:
        # item_dict = follow.to_dict()
        # response = self.table.put_item(Item=item_dict)
        pass

    def unfollow_user(self, user_id: str, follower_id: str) -> bool:
        """Unfollow a user"""
        # TODO: Implement Access Pattern #11
        # Operation: DeleteItem | Index: Main Table
        #
        # Main Table DeleteItem Example:
        # pk = Follow.build_pk_for_lookup(pk_params)
        # sk = Follow.build_sk_for_lookup(sk_params)
...
class LikeRepository(BaseRepository[Like]):
    ...
    def like_post(self, like: Like) -> Like | None:
        ...
        #
        # Main Table PutItem Example:
        # item_dict = like.to_dict()
        # response = self.table.put_item(Item=item_dict)
        pass

    def unlike_post(self, user_id: str, post_id: str, liker_user_id: str) -> bool:
        """Unlike a post"""
        # TODO: Implement Access Pattern #8
        # Operation: DeleteItem | Index: Main Table
        #
        # Main Table DeleteItem Example:
        # pk = Like.build_pk_for_lookup(pk_params)
        # sk = Like.build_sk_for_lookup(sk_params)
        # response = self.table.delete_item(
        #     Key={'user_id': pk, 'sort_key': sk}
        # )
        pass
...
class UserProfileRepository(BaseRepository[UserProfile]):
    ...
    def get_user_profile_and_posts(self, user_id: str) -> dict:
