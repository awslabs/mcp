...
class TestPythonSnapshotGeneration:
    ...
    def test_healthcare_snapshot(self, generation_output_dir, sample_schemas, code_generator):
        """Test that healthcare generation matches expected snapshot."""
        result = code_generator(
            sample_schemas['healthcare'],
            generation_output_dir,
            generate_sample_usage=True,
            # Enable linting for consistent, high-quality output
        )
...
class TestPythonSnapshotManagement:
    ...
    def test_snapshot_directory_structure(self):
        ...
        expected_schemas = ['social_media', 'ecommerce', 'elearning', 'healthcare', 'saas']
