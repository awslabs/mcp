...
class TestPythonCodeGenerationPipeline:
    ...
    def test_linting_integration(
        self, generation_output_dir, sample_schemas, code_generator, repo_generation_tool_path
    ):
        ...
        assert ruff_result.returncode == 0, (
            f'Generated code failed manual ruff check: {ruff_result.stdout}'
        )
...
class TestSchemaValidationIntegration:
    ...
    def test_all_valid_schemas_pass_validation(self, sample_schemas, code_generator, tmp_path):
        ...
        valid_schema_names = ['social_media', 'ecommerce', 'elearning', 'healthcare', 'saas']
...
class TestComprehensiveGeneration:
    ...
    def test_all_sample_schemas_generation(self, tmp_path, sample_schemas, code_generator):
        ...
        valid_schemas = ['social_media', 'ecommerce', 'elearning', 'healthcare', 'saas']
