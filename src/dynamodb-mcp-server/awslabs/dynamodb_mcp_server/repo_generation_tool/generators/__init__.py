...
def create_generator(
    generator_type: str, schema_path: str, language: str = 'python', templates_dir: str = None
):
    """Factory function to create a generator instance."""
    if generator_type == 'jinja2':
        return Jinja2Generator(schema_path, templates_dir, language)
    else:
        raise ValueError(f'Unknown generator type: {generator_type}')


__all__ = ['Jinja2Generator', 'create_generator']
