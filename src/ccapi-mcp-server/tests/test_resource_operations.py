...
from awslabs.ccapi_mcp_server.impl.tools.resource_operations import (
    create_resource_impl, update_resource_impl, delete_resource_impl,
    get_resource_impl, get_resource_request_status_impl, _validate_token_chain,
    check_readonly_mode, check_security_scanning
)
from awslabs.ccapi_mcp_server.models.models import (
    CreateResourceRequest, UpdateResourceRequest, DeleteResourceRequest, GetResourceRequest
)
...
class TestResourceOperations:
    ...
    async def test_create_resource_impl_success(self, mock_environ, mock_client):
        ...
        workflow_store = {
            'creds': {'type': 'credentials', 'data': {'credentials_valid': True, 'readonly_mode': False}},
            'explained': {'type': 'explained_properties', 'data': {'properties': {'test': 'value'}}}
        }
        ...
        with patch('awslabs.ccapi_mcp_server.impl.tools.resource_operations.progress_event') as mock_progress:
    ...
    async def test_delete_resource_impl_success(self, mock_client):
        ...
        workflow_store = {
            'creds': {'type': 'credentials', 'data': {'credentials_valid': True, 'readonly_mode': False}},
            'explained': {'type': 'explained_delete', 'data': {'test': 'value'}, 'operation': 'delete'}
        }
    ...
    async def test_delete_resource_impl_wrong_operation(self):
        ...
        workflow_store = {
            'creds': {'type': 'credentials', 'data': {'credentials_valid': True, 'readonly_mode': False}},
            'explained': {'type': 'explained_delete', 'data': {'test': 'value'}, 'operation': 'create'}
        }
    ...
    async def test_update_resource_impl_readonly_mode_error(self):
        ...
        workflow_store = {
            'creds': {'type': 'credentials', 'data': {'credentials_valid': True, 'readonly_mode': True}},
            'explained': {'type': 'explained_properties', 'data': {'properties': {'test': 'value'}}}
        }
    ...
    def test_check_readonly_mode_context(self):
        ...
        with patch('awslabs.ccapi_mcp_server.impl.tools.resource_operations.Context') as mock_context:
    ...
    def test_check_readonly_mode_with_context(self):
        ...
        with patch('awslabs.ccapi_mcp_server.impl.tools.resource_operations.Context.readonly_mode', return_value=True):
            with pytest.raises(ClientError):
                check_readonly_mode({'readonly_mode': False})
