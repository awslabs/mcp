...
class TestGetSavingsPlansUtilizationDetails:
    ...
    @patch("awslabs.billing_cost_management_mcp_server.tools.sp_performance_tools.paginate_aws_response")
    async def test_get_savings_plans_utilization_details_basic(
        ...
        mock_paginate_response.return_value = (
            mock_ce_client.get_savings_plans_utilization_details.return_value["SavingsPlansUtilizationDetails"],
            {"NextToken": None}
        )
    ...
    @patch("awslabs.billing_cost_management_mcp_server.tools.sp_performance_tools.get_date_range")
    @patch("awslabs.billing_cost_management_mcp_server.tools.sp_performance_tools.handle_aws_error")
...
def test_sp_performance_server_initialization():
    ...
    assert "Tools for working with AWS Savings Plans Performance" in sp_performance_server.instructions