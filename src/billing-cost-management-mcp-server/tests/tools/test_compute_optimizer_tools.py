...
class TestGetEC2InstanceRecommendations:
    ...
    async def test_get_ec2_instance_recommendations_with_filters(self, mock_context, mock_co_client):
...
def test_compute_optimizer_server_initialization():
    ...
    assert "Tools for working with AWS Compute Optimizer API" in compute_optimizer_server.instructions