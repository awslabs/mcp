...
async def aws_pricing(ctx, operation, **kwargs):
    ...
    if operation == "get_service_codes":
        from awslabs.billing_cost_management_mcp_server.tools.aws_pricing_operations import get_service_codes
        ...
        if not kwargs.get("service_code"):
            return format_response(
                "error",
                {},
                "service_code is required for get_service_attributes operation"
            )
        
        from awslabs.billing_cost_management_mcp_server.tools.aws_pricing_operations import get_service_attributes
        ...
        from awslabs.billing_cost_management_mcp_server.tools.aws_pricing_operations import get_attribute_values
        return await get_attribute_values(ctx, kwargs.get("service_code"), kwargs.get("attribute_name"), kwargs.get("max_results"))
        ...
        from awslabs.billing_cost_management_mcp_server.tools.aws_pricing_operations import get_pricing_from_api
...
class TestAwsPricing:
    ...
    @patch("awslabs.billing_cost_management_mcp_server.tools.aws_pricing_operations.get_service_codes")
    async def test_aws_pricing_get_service_codes(
        self, mock_get_service_codes, mock_context
    ):
    ...
    @patch("awslabs.billing_cost_management_mcp_server.tools.aws_pricing_operations.get_service_attributes")
    ...
    @patch("awslabs.billing_cost_management_mcp_server.tools.aws_pricing_operations.get_attribute_values")
    async def test_aws_pricing_get_attribute_values(
        self, mock_get_attribute_values, mock_context
    ):
    ...
    @patch("awslabs.billing_cost_management_mcp_server.tools.aws_pricing_operations.get_pricing_from_api")
    async def test_aws_pricing_get_pricing_from_api(
        self, mock_get_pricing_from_api, mock_context
    ):
    ...
    async def test_aws_pricing_missing_service_code(
    ...
    @patch("awslabs.billing_cost_management_mcp_server.utilities.aws_service_base.format_response")
    async def test_aws_pricing_missing_attribute_name(
        self, mock_format_response, mock_context
    ):
    ...
    @patch("awslabs.billing_cost_management_mcp_server.utilities.aws_service_base.format_response")
    async def test_aws_pricing_missing_region(
        self, mock_format_response, mock_context
    ):
    ...
    @patch("awslabs.billing_cost_management_mcp_server.utilities.aws_service_base.format_response")
    async def test_aws_pricing_unknown_operation(
        self, mock_format_response, mock_context
    ):
    ...
    @patch("awslabs.billing_cost_management_mcp_server.tools.aws_pricing_operations.get_service_codes")
    async def test_aws_pricing_error_handling(
        self, mock_get_service_codes, mock_context
    ):
