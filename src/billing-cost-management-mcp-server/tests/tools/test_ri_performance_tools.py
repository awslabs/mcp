...
class TestGetReservationCoverage:
    ...
    @patch("awslabs.billing_cost_management_mcp_server.tools.ri_performance_tools.paginate_aws_response")
    ...
    async def test_get_reservation_coverage_with_options(
        self, mock_parse_json, mock_paginate_response, mock_get_date_range, 
    ...
    @patch("awslabs.billing_cost_management_mcp_server.tools.ri_performance_tools.get_date_range")
    @patch("awslabs.billing_cost_management_mcp_server.tools.ri_performance_tools.handle_aws_error")
    async def test_get_reservation_coverage_error(
        ...
        # Assert
        mock_handle_aws_error.assert_called_once_with(mock_context, error, "get_reservation_coverage", "Cost Explorer")
...
class TestGetReservationUtilization:
    ...
    async def test_get_reservation_utilization_error(
        ...
        # Assert
        mock_handle_aws_error.assert_called_once_with(mock_context, error, "get_reservation_utilization", "Cost Explorer")
        assert result["status"] == "error"
        assert result["message"] == "API error"
...
def test_ri_performance_server_initialization():
    ...
    assert "Tools for working with AWS Reserved Instance Performance" in ri_performance_server.instructions