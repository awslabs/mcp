...
import awslabs.billing_cost_management_mcp_server.tools.cost_comparison_tools
...
async def cost_comparison(ctx, operation, **kwargs):
    ...
    if operation == "getCostAndUsageComparisons":
        if not kwargs.get("baseline_start_date") or not kwargs.get("baseline_end_date") or \
           not kwargs.get("comparison_start_date") or not kwargs.get("comparison_end_date"):
...
class TestGetCostAndUsageComparisons:
    ...
    async def test_get_cost_and_usage_comparisons_with_group_by(self, mock_context, mock_ce_client):
    ...
    async def test_get_cost_and_usage_comparisons_with_max_results(self, mock_context, mock_ce_client):
    ...
    async def test_get_cost_and_usage_comparisons_with_billing_view_arn(self, mock_context, mock_ce_client):
    ...
    async def test_get_cost_and_usage_comparisons_with_pagination(self, mock_context, mock_ce_client):
        ...
        mock_ce_client.get_cost_and_usage_comparisons.side_effect = [
            {
                "CostAndUsageComparisons": [{"CostAndUsageSelector": {"Key": "SERVICE", "Values": ["Amazon EC2"]}}],
                "TotalCostAndUsage": {"BlendedCost": {"BaselineTimePeriodAmount": "100.0"}},
                "NextPageToken": "page2token",
            },
            {
                "CostAndUsageComparisons": [{"CostAndUsageSelector": {"Key": "SERVICE", "Values": ["Amazon S3"]}}],
                "NextPageToken": None,
            },
        ]
    ...
    @patch("awslabs.billing_cost_management_mcp_server.tools.cost_comparison_tools.handle_aws_error")
    async def test_get_cost_and_usage_comparisons_error_handling(
        ...
        # Assert
        mock_handle_aws_error.assert_called_once_with(mock_context, error, "get_cost_and_usage_comparisons", "Cost Explorer")
...
class TestGetCostComparisonDrivers:
    ...
    async def test_get_cost_comparison_drivers_with_max_results(self, mock_context, mock_ce_client):
    ...
    async def test_get_cost_comparison_drivers_with_billing_view_arn(self, mock_context, mock_ce_client):
    ...
    async def test_get_cost_comparison_drivers_with_pagination(self, mock_context, mock_ce_client):
        ...
        mock_ce_client.get_cost_comparison_drivers.side_effect = [
            {
                "CostComparisonDrivers": [{"CostSelector": {"Key": "SERVICE", "Values": ["Amazon EC2"]}}],
                "NextPageToken": "page2token",
            },
            {
                "CostComparisonDrivers": [{"CostSelector": {"Key": "SERVICE", "Values": ["Amazon S3"]}}],
                "NextPageToken": None,
            },
        ]
    ...
    async def test_get_cost_comparison_drivers_error_handling(
        ...
        # Assert
        mock_handle_aws_error.assert_called_once_with(mock_context, error, "get_cost_comparison_drivers", "Cost Explorer")
        assert result["status"] == "error"
        assert result["message"] == "API error"
