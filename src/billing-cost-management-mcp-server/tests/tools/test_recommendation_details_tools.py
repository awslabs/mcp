...
class TestGetSavingsPlansRecommendation:
    ...
    async def test_get_savings_plans_recommendation_success(self, mock_context, mock_ce_client):
        ...
        # Execute
        result = await get_savings_plans_recommendation(mock_context, recommendation, mock_ce_client)
    ...
    async def test_get_savings_plans_recommendation_missing_key(self, mock_context, mock_ce_client):
    ...
    async def test_get_savings_plans_recommendation_missing_params(self, mock_context, mock_ce_client):
...
class TestGetReservedInstancesRecommendation:
    ...
    async def test_get_reserved_instances_recommendation_success(self, mock_context, mock_ce_client):
        ...
        # Execute
        result = await get_reserved_instances_recommendation(mock_context, recommendation, mock_ce_client)
        ...
        assert result["Recommendations"][0]["RecommendationSummary"]["EstimatedSavingsAmount"] == "2000.0"

    async def test_get_reserved_instances_recommendation_missing_key(self, mock_context, mock_ce_client):
    ...
    async def test_get_reserved_instances_recommendation_missing_params(self, mock_context, mock_ce_client):
    ...
    async def test_get_reserved_instances_recommendation_api_error(self, mock_context, mock_ce_client):
...
class TestGetCostExplorerData:
    ...
    @patch("awslabs.billing_cost_management_mcp_server.tools.recommendation_details_tools.get_savings_plans_recommendation")
    ...
    @patch("awslabs.billing_cost_management_mcp_server.tools.recommendation_details_tools.get_reserved_instances_recommendation")
...
class TestGetComputeOptimizerData:
    ...
    @patch("awslabs.billing_cost_management_mcp_server.tools.recommendation_details_tools.create_aws_client")
    async def test_get_compute_optimizer_data_idle_resource(
        ...
        # Assert
        mock_create_aws_client.assert_called_once_with("compute-optimizer", region_name="us-east-1")
    ...
    async def test_get_compute_optimizer_data_ec2_asg(
        ...
        mock_compute_optimizer_client.get_auto_scaling_group_recommendations.assert_called_once_with(
            autoScalingGroupArns=["arn:aws:autoscaling:us-east-1:123456789012:autoScalingGroup:123:autoScalingGroupName/asg-test"]
        )
...
class TestProcessRecommendation:
    ...
    @patch("awslabs.billing_cost_management_mcp_server.tools.recommendation_details_tools.get_compute_optimizer_data")
    @patch("awslabs.billing_cost_management_mcp_server.tools.recommendation_details_tools.format_base_recommendation")
    @patch("awslabs.billing_cost_management_mcp_server.tools.recommendation_details_tools.get_template_for_recommendation")
    ...
    @patch("awslabs.billing_cost_management_mcp_server.tools.recommendation_details_tools.get_cost_explorer_data")
    @patch("awslabs.billing_cost_management_mcp_server.tools.recommendation_details_tools.format_base_recommendation")
    @patch("awslabs.billing_cost_management_mcp_server.tools.recommendation_details_tools.get_template_for_recommendation")
...
def test_recommendation_details_server_initialization():
    ...
    assert "Tools for working with AWS Cost Optimization Hub enhanced recommendation details" in recommendation_details_server.instructions