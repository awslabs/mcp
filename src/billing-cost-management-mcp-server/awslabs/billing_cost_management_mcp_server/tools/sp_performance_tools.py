...
async def get_savings_plans_coverage(
    ...
    try:
        ...
        # Log the time period
        await ctx.info(f"Analyzing Savings Plans coverage from {start} to {end} with {granularity} granularity")
...
async def get_savings_plans_utilization(
    ...
    try:
        ...
        # Log the time period
        await ctx.info(f"Analyzing Savings Plans utilization from {start} to {end} with {granularity} granularity")
...
async def get_savings_plans_utilization_details(
    ...
    try:
        ...
        # Use shared error handler for consistent error reporting
        return await handle_aws_error(ctx, e, "get_savings_plans_utilization_details", "Cost Explorer")