...
from terraform_mcp_server.impl.resources.terraform_aws_provider_resources_listing import (  # noqa: E402
    fetch_aws_provider_page,
)


# Default output path
DEFAULT_OUTPUT_PATH = repo_root / 'terraform_mcp_server' / 'static' / 'AWS_PROVIDER_RESOURCES.md'
