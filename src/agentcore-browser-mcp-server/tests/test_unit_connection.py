...
# Patch paths
PATCH_PW = 'awslabs.agentcore_browser_mcp_server.browser.connection_manager.async_playwright'
PATCH_CLIENT = 'awslabs.agentcore_browser_mcp_server.browser.connection_manager.get_browser_client'
