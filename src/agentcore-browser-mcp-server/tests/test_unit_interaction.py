...
from awslabs.agentcore_browser_mcp_server.tools.interaction import (
    InteractionTools,
    _wait_for_settled,
)
...
class TestNavigationTools:
    ...
    def test_validate_url_scheme_parse_error(self):
        ...
        from awslabs.agentcore_browser_mcp_server.tools.navigation import (
            _validate_url_scheme,
        )

        with patch(
            'awslabs.agentcore_browser_mcp_server.tools.navigation.urlparse',
...
class TestObservationTools:
    ...
    def test_register_evaluate_disabled(self, mock_connection_manager, mock_snapshot_manager):
        ...
        with patch(
            'awslabs.agentcore_browser_mcp_server.tools.observation.BROWSER_EVALUATE_DISABLED',
            True,
        ):
