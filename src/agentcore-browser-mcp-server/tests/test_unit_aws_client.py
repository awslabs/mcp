...
from awslabs.agentcore_browser_mcp_server.utils.aws_client import (
...
PATCH_BROWSER_CLIENT = 'awslabs.agentcore_browser_mcp_server.utils.aws_client.BrowserClient'
