...
import pytest
import re
from awslabs.agentcore_browser_mcp_server.browser.connection_manager import (
    BrowserConnectionManager,
)
from awslabs.agentcore_browser_mcp_server.browser.snapshot_manager import (
    SnapshotManager,
)
from awslabs.agentcore_browser_mcp_server.tools.interaction import InteractionTools
from awslabs.agentcore_browser_mcp_server.tools.management import ManagementTools
from awslabs.agentcore_browser_mcp_server.tools.navigation import NavigationTools
from awslabs.agentcore_browser_mcp_server.tools.observation import ObservationTools
from awslabs.agentcore_browser_mcp_server.tools.session import BrowserSessionTools
...
class TestNavigationAndObservation:
    ...
    async def test_navigate(self, nav_env):
        ...
        assert result.startswith('Navigated to https://example.com')
