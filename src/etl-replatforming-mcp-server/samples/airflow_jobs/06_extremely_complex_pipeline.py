...
dag = DAG(
    'extremely_complex_multi_source_etl_pipeline',
...
[wait_for_customer_data, wait_for_transaction_data, wait_for_product_data] >> determine_strategy
...
[determine_strategy, high_perf_group, standard_group, lightweight_processing, 
 transform_group, data_quality_checks, generate_executive_report] >> cleanup_on_failure