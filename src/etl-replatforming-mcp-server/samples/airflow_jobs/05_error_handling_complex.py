...
dag = DAG(
    'complex_etl_pipeline_with_error_handling',
...
# Define dependencies
start_logging >> extract_source_data >> validate_data_quality >> transform_clean_data >> load_to_warehouse

# Success path
load_to_warehouse >> cleanup_on_success

# Error handling paths
[extract_source_data, validate_data_quality, transform_clean_data, load_to_warehouse] >> handle_quality_issues
[extract_source_data, validate_data_quality, transform_clean_data, load_to_warehouse] >> send_error_notification
[extract_source_data, validate_data_quality, transform_clean_data, load_to_warehouse] >> cleanup_on_failure