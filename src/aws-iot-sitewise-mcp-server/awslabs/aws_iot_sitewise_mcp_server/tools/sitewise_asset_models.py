...
def describe_asset_model(
    asset_model_id: str = Field(..., description='The ID of the asset model (UUID format: 12345678-1234-1234-1234-123456789012 or external ID format: externalId:my-external-id)'),
    region: str = Field('us-east-1', description='AWS region'),
...
def update_asset_model(
    asset_model_id: str = Field(..., description='The ID of the asset model to update (UUID format: 12345678-1234-1234-1234-123456789012 or external ID format: externalId:my-external-id)'),
    asset_model_name: str = Field(..., description='A unique, friendly name for the asset model'),
    region: str = Field('us-east-1', description='AWS region'),
    asset_model_description: Optional[str] = Field(
        None, description='A description for the asset model'
...
def delete_asset_model(
    asset_model_id: str = Field(..., description='The ID of the asset model to delete (UUID format: 12345678-1234-1234-1234-123456789012 or external ID format: externalId:my-external-id)'),
    region: str = Field('us-east-1', description='AWS region'),
    client_token: Optional[str] = Field(
        None, description='A unique case-sensitive identifier for the request'
    ),
