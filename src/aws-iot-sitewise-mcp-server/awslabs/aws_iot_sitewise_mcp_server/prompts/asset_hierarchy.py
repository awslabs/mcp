...
def asset_hierarchy_visualization(asset_id: str) -> str:
    """
    Generate a comprehensive analysis and \
        visualization of AWS IoT SiteWise asset hierarchies.
...
asset_hierarchy_visualization_prompt = Prompt.from_function(
    ...
    description=(
        "Generate comprehensive analysis and visualization of AWS "
        "IoT SiteWise asset hierarchies"
    ),
)
