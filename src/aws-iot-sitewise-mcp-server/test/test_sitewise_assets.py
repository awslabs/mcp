...
class TestSiteWiseAssets:
    ...
    def test_create_asset_success(self, mock_boto_client):
        ...
        mock_response = {
            ...
            "assetArn": "arn:aws:iotsitewise:us-east-1:<account-id>:asset/test-asset-123",
        ...
        assert (
            result["asset_arn"] == "arn:aws:iotsitewise:us-east-1:<account-id>:asset/test-asset-123"
        )
    ...
    def test_list_assets_validation_errors(self):
        ...
        result = list_assets(next_token="x" * 4097)  # Exceeds 4096 character limit
        assert result["success"] is False
    ...
    def test_list_assets_with_all_params(self, mock_boto_client):
        ...
        mock_client.list_assets.assert_called_once_with(
            maxResults=100, nextToken="prev-token", assetModelId="model-123", filter="TOP_LEVEL"
        )
