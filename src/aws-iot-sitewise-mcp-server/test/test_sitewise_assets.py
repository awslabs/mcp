...
class TestSiteWiseAssets:
    ...
    def test_create_asset_failure(self, mock_boto_client):
        ...
        mock_client.create_asset.side_effect = ClientError(
            error_response, "CreateAsset"
        )
    ...
    def test_additional_client_error_handling(self, mock_boto_client):
        ...
        mock_client.describe_asset.side_effect = ClientError(
            error_response, "DescribeAsset"
        )
        ...
        mock_client.delete_asset.side_effect = ClientError(
            error_response, "DeleteAsset"
        )
        ...
        mock_client.associate_assets.side_effect = ClientError(
            error_response, "AssociateAssets"
        )
