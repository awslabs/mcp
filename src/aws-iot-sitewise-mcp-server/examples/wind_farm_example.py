...
def create_wind_turbine_model() -> Dict[str, Any]:
    ...
    result = {
        ...
        "asset_model_arn": "arn:aws:iotsitewise:us-east-1:<account-id>:asset-model/wind-turbine-model-123"
    }
...
def create_wind_farm_model() -> Dict[str, Any]:
    ...
    hierarchies = [
        {
            "name": "Turbines",
            "childAssetModelId": "wind-turbine-model-123"
        }
    ]
    ...
    result = {
        ...
        "asset_model_arn": "arn:aws:iotsitewise:us-east-1:<account-id>:asset-model/wind-farm-model-456"
    }
...
def create_assets() -> Dict[str, Any]:
    ...
    wind_farm = {
        ...
        "asset_arn": "arn:aws:iotsitewise:us-east-1:<account-id>:asset/wind-farm-001"
    }
    ...
    for i in range(1, 6):  # Create 5 turbines
        ...
        turbine = {
            ...
            "asset_arn": f"arn:aws:iotsitewise:us-east-1:<account-id>:asset/turbine-{i:03d}"
        }
...
def main():
    ...
    try:
        ...
        turbine_model = create_wind_turbine_model()
        farm_model = create_wind_farm_model()
