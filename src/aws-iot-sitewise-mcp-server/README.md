...
| Tool Name | Description |
|-----------|-------------|
| `create_computation_model` | Create generic computation models with custom configuration and data bindings |
...
| `describe_computation_model_execution_summary` | Get execution summary with smart configuration type detection |
| `list_computation_model_data_binding_usages` | Find computation models using specific assets or properties |
| `list_computation_model_resolve_to_resources` | List resources that computation models resolve to |

### Action & Execution Management Tools

| Tool Name | Description |
|-----------|-------------|
| `execute_action` | Execute generic actions on target resources (assets or computation models) |
