...
class TestTimestampTools:
    ...
    def test_create_timestamp_range_custom_format(self):
        ...
        result = create_timestamp_range(start_timestamp, end_timestamp, format_string=custom_format)
    ...
    def test_create_timestamp_range_exception_handling(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.timestamp_tools.datetime') as mock_datetime:
