...
class TestSiteWiseComputationModels:
    ...
    @patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.create_sitewise_client')
    ...
    def test_create_computation_model_client_error(self, mock_boto_client):
        ...
        mock_client.create_computation_model.side_effect = ClientError(error_response, 'CreateComputationModel')
    ...
    def test_create_anomaly_detection_model_success(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.create_computation_model') as mock_create:
    ...
    def test_describe_computation_model_success(self, mock_boto_client):
        ...
        mock_response['computationModelCreationDate'].isoformat.return_value = '2023-01-01T00:00:00Z'
        mock_response['computationModelLastUpdateDate'].isoformat.return_value = '2023-01-01T00:00:00Z'
    ...
    def test_list_computation_model_resolve_to_resources_success(self, mock_boto_client):
        ...
        assert result['success'] is True
        assert result['computationModelVersion'] == '2'
        mock_client.describe_computation_model.assert_called_once_with(
            computationModelId='87654321-4321-4321-4321-210987654321',
            computationModelVersion='2',
        )
    ...
    @patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.describe_computation_model')
    def test_determine_computation_model_configuration_type_auto_detect_asset_model(self, mock_describe):
    ...
    @patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.describe_computation_model')
    def test_determine_computation_model_configuration_type_auto_detect_asset_level(self, mock_describe):
    ...
    @patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models._determine_computation_model_configuration_type')
    @patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.create_sitewise_client')
    def test_describe_computation_model_execution_summary_asset_model_level(self, mock_boto_client, mock_determine_type):
        ...
        mock_response = {
            ...
            'resolveTo': {'resourceId': '87654321-4321-4321-4321-210987654321', 'resourceType': 'ASSET'},
        }
    ...
    @patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models._determine_computation_model_configuration_type')
    @patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.create_sitewise_client')
    def test_describe_computation_model_execution_summary_asset_level(self, mock_boto_client, mock_determine_type):
    ...
    def test_delete_computation_model_client_error(self, mock_boto_client):
        ...
        mock_client.delete_computation_model.side_effect = ClientError(error_response, 'DeleteComputationModel')
    ...
    def test_update_computation_model_client_error(self, mock_boto_client):
        ...
        mock_client.update_computation_model.side_effect = ClientError(error_response, 'UpdateComputationModel')
    ...
    def test_list_computation_models_client_error(self, mock_boto_client):
        ...
        mock_client.list_computation_models.side_effect = ClientError(error_response, 'ListComputationModels')
    ...
    def test_describe_computation_model_client_error(self, mock_boto_client):
        ...
        mock_client.describe_computation_model.side_effect = ClientError(error_response, 'DescribeComputationModel')
    ...
    @patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models._determine_computation_model_configuration_type')
    @patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.create_sitewise_client')
    def test_describe_computation_model_execution_summary_client_error(self, mock_boto_client, mock_determine_type):
        ...
        mock_client.describe_computation_model_execution_summary.side_effect = ClientError(error_response, 'DescribeComputationModelExecutionSummary')
    ...
    def test_list_computation_model_data_binding_usages_client_error(self, mock_boto_client):
        ...
        mock_client.list_computation_model_data_binding_usages.side_effect = ClientError(error_response, 'ListComputationModelDataBindingUsages')
    ...
    def test_list_computation_model_resolve_to_resources_client_error(self, mock_boto_client):
        ...
        mock_client.list_computation_model_resolve_to_resources.side_effect = ClientError(error_response, 'ListComputationModelResolveToResources')
    ...
    @patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models._determine_computation_model_configuration_type')
    def test_describe_computation_model_execution_summary_determine_type_error(self, mock_determine_type):
    ...
    def test_create_computation_model_validation_error(self):
        ...
        assert result['success'] is False
        assert result['error_code'] == 'InvalidRequestException'
        assert 'ComputationModelConfiguration has 0 types defined' in result['error']
    ...
    def test_update_computation_model_validation_error(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            update_computation_model(
                computation_model_id='invalid-id-format',  # This will trigger validation error
                computation_model_name='Updated Model',
                computation_model_configuration={'anomalyDetection': {'inputProperties': '${input}', 'resultProperty': '${result}'}},
                computation_model_data_binding={'input': {'assetProperty': {'assetId': '12345678-1234-1234-1234-123456789012', 'propertyId': '11111111-1111-1111-1111-111111111111'}}},
            )
    ...
    def test_list_computation_model_data_binding_usages_validation_error(self):
        ...
        assert 'must define exactly one of: asset, assetModel, assetProperty, or assetModelProperty' in str(exc_info.value)
    ...
    def test_create_computation_model_custom_validation_error(self):
        ...
        from awslabs.aws_iot_sitewise_mcp_server.validation import ValidationError as CustomValidationError
        
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.ComputationModelConfiguration') as mock_config:
    ...
    def test_delete_computation_model_custom_validation_error(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.DeleteComputationModelRequest') as mock_request:
    ...
    def test_list_computation_models_custom_validation_error(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.ListComputationModelsRequest') as mock_request:
            mock_request.side_effect = CustomValidationError("Test validation error")
    ...
    def test_describe_computation_model_custom_validation_error(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.DescribeComputationModelRequest') as mock_request:
            mock_request.side_effect = CustomValidationError("Test validation error")
    ...
    def test_describe_computation_model_execution_summary_custom_validation_error(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models._determine_computation_model_configuration_type') as mock_determine:
            ...
            with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.DescribeComputationModelExecutionSummaryRequest') as mock_request:
                mock_request.side_effect = CustomValidationError("Test validation error")
    ...
    def test_list_computation_model_data_binding_usages_custom_validation_error(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.DataBindingValueFilter') as mock_filter:
    ...
    def test_list_computation_model_resolve_to_resources_custom_validation_error(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.ListComputationModelResolveToResourcesRequest') as mock_request:
            mock_request.side_effect = CustomValidationError("Test validation error")
    ...
    @patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.describe_computation_model')
    def test_determine_computation_model_configuration_type_direct_asset_model_property(self, mock_describe):
    ...
    @patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models._determine_computation_model_configuration_type')
    @patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.create_sitewise_client')
    def test_describe_computation_model_execution_summary_asset_model_level_no_resolve_params(self, mock_boto_client, mock_determine_type):
    ...
    @patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_computation_models.describe_computation_model')
    def test_determine_computation_model_configuration_type_non_dict_binding_value(self, mock_describe):
