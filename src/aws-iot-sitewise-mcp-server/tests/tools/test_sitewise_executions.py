...
class TestSiteWiseExecutions:
    ...
    def test_execute_training_action_validation_error_partial_label_config(self):
        ...
        assert 'Both label_bucket_name and label_s3_prefix must be provided together' in result['error']
    ...
    def test_execute_training_action_validation_error_partial_metrics_config(self):
        ...
        assert result['success'] is False
        assert result['error_code'] == 'ValidationException'
        assert 'Both metrics_bucket_name and metrics_s3_prefix must be provided together' in result['error']
    ...
    def test_describe_execution_client_error(self, mock_boto_client):
        ...
        mock_client.describe_execution.side_effect = ClientError(error_response, 'DescribeExecution')
    ...
    def test_execute_training_action_minimal_params(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_executions.execute_action') as mock_execute_action:
            mock_execute_action.return_value = {
                'success': True,
                'actionId': '12345678-1234-1234-1234-123456789012',
            }
            ...
            assert 'retrainingConfiguration' not in payload or payload.get('retrainingConfiguration') is None
    ...
    def test_execute_inference_action_minimal_params(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_executions.execute_action') as mock_execute_action:
            ...
            assert 'dataUploadFrequency' not in payload or payload.get('dataUploadFrequency') is None
    ...
    def test_list_executions_validation_exception_handling(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_executions.ListExecutionsRequest') as mock_request:
    ...
    def test_describe_execution_validation_exception_handling(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_executions.DescribeExecutionRequest') as mock_request:
            mock_request.side_effect = CustomValidationError("Test validation error")
    ...
    def test_execute_action_custom_validation_error(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_executions.ExecuteActionRequest') as mock_request:
            mock_request.side_effect = CustomValidationError("Test validation error")
    ...
    def test_list_actions_custom_validation_error(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_executions.ListActionsRequest') as mock_request:
            mock_request.side_effect = CustomValidationError("Test validation error")
    ...
    def test_describe_action_custom_validation_error(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_executions.DescribeActionRequest') as mock_request:
            mock_request.side_effect = CustomValidationError("Test validation error")
    ...
    def test_execute_inference_action_custom_validation_error(self):
        ...
        with patch('awslabs.aws_iot_sitewise_mcp_server.tools.sitewise_executions.InferencePayload') as mock_payload:
