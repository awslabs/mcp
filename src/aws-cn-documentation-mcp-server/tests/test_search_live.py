...
"""Live test for the search_documentation tool in the AWS China Documentation MCP server."""

import asyncio
import pytest
from awslabs.aws_cn_documentation_mcp_server.server import search_documentation
