...
try:
    ...
    contributor_insights_tools = ContributorInsightsTools()
    contributor_insights_tools.register(mcp)
    logger.info('Contributor Insights tools registered successfully')
