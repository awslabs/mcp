...
|-------|-------------|-------------|
| [AgentCore Investigation](skills/agentcore-investigation/SKILL.md) | Investigate Bedrock AgentCore runtime sessions — resolve session/trace IDs, query OTEL spans, filter noise, build timelines | [Kiro CLI setup](skills/kiro_skill_setup.md) |
