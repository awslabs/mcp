...
class TestMain:
    ...
    @patch('awslabs.aws_finops_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.aws-finops-mcp-server'])
    def test_main_default(self, mock_run):
        """Test main function with default arguments."""
        # Import main inside the test function
        from awslabs.aws_finops_mcp_server.server import main
    ...
    def test_module_execution(self):
        ...
        import inspect
        from awslabs.aws_finops_mcp_server import server
