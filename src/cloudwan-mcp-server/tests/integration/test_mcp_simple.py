...
async def test_mcp_server_direct():
    ...
    try:
        from awslabs.cloudwan_mcp_server.tools.cloudwan.policy_management import (
            GetCoreNetworkPolicyTool,
            GetCoreNetworkChangeSetTool,
            GetCoreNetworkChangeEventsTool
        )
