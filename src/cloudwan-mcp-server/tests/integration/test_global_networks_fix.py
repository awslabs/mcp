...
async def test_global_networks_response_model():
    ...
    try:
        ...
        from awslabs.cloudwan_mcp_server.models.network import GlobalNetworksResponse, GlobalNetworkInfo
...
async def test_import_conflicts():
    ...
    try:
        ...
        from awslabs.cloudwan_mcp_server.models.network import GlobalNetworksResponse as NetworkResponse
