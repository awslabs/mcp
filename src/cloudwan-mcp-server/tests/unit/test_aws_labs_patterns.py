...
class TestAWSLabsPatterns:
    ...
    @pytest.mark.unit
    def test_server_module_available(self):
        """Test server module is available and has expected functions."""
        from awslabs.cloudwan_mcp_server.utils.validation import validate_core_network_id, validate_global_network_id, validate_ip_address
    ...
    async def test_aws_service_error_handling(self, mock_boto3):
