...
from awslabs.perforce_mcp_server.server import main
...
class TestMain:
    ...
    @patch('awslabs.perforce_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.perforce-mcp-server'])
    ...
    @patch('awslabs.perforce_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.perforce-mcp-server', '--sse', '--port', '9999'])
    def test_main_sse(self, mock_run):
        ...
        from awslabs.perforce_mcp_server.server import mcp
    ...
    def test_module_execution(self):
        ...
        import inspect
        from awslabs.perforce_mcp_server import server
