...
async def test_run_query_well_formatted_response():
    ...
    DBConnectionSingleton.initialize('mock', 'mock', 'mock', resource_arn='mock', readonly=True, is_test=True)
...
async def test_run_query_write_queries_on_write_allowed_setting():
    ...
    DBConnectionSingleton.initialize('mock', 'mock', 'mock', resource_arn='mock', readonly=False, is_test=True)
