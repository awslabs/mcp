...
| [Cell-Based Architecture MCP Server](src/cell-based-architecture-mcp-server) | Expert guidance on cell-based architecture patterns, design principles, and AWS Well-Architected best practices for building resilient, scalable systems | [![Install](https://img.shields.io/badge/Install-Cursor-blue?style=flat-square&logo=cursor)](https://cursor.com/install-mcp?name=awslabs.cell-based-architecture-mcp-server&config=eyJjb21tYW5kIjoidXZ4IGF3c2xhYnMuY2VsbC1iYXNlZC1hcmNoaXRlY3R1cmUtbWNwLXNlcnZlckBsYXRlc3QiLCJlbnYiOnsiRkFTVE1DUF9MT0dfTEVWRUwiOiJFUlJPUiJ9LCJkaXNhYmxlZCI6ZmFsc2UsImF1dG9BcHByb3ZlIjpbXX0%3D) <br/>[![Install on VS Code](https://img.shields.io/badge/Install-VS_Code-FF9900?style=flat-square&logo=visualstudiocode&logoColor=white)](https://insiders.vscode.dev/redirect/mcp/install?name=Cell-Based%20Architecture%20MCP%20Server&config=%7B%22command%22%3A%22uvx%22%2C%22args%22%3A%5B%22awslabs.cell-based-architecture-mcp-server%40latest%22%5D%2C%22env%22%3A%7B%22FASTMCP_LOG_LEVEL%22%3A%22ERROR%22%7D%2C%22disabled%22%3Afalse%2C%22autoApprove%22%3A%5B%5D%7D) |
...
| [Cell-Based Architecture MCP Server](src/cell-based-architecture-mcp-server) | Expert guidance on cell-based architecture patterns and AWS Well-Architected best practices | [![Install](https://img.shields.io/badge/Install-Cursor-blue?style=flat-square&logo=cursor)](https://cursor.com/install-mcp?name=awslabs.cell-based-architecture-mcp-server&config=eyJjb21tYW5kIjoidXZ4IGF3c2xhYnMuY2VsbC1iYXNlZC1hcmNoaXRlY3R1cmUtbWNwLXNlcnZlckBsYXRlc3QiLCJlbnYiOnsiRkFTVE1DUF9MT0dfTEVWRUwiOiJFUlJPUiJ9LCJkaXNhYmxlZCI6ZmFsc2UsImF1dG9BcHByb3ZlIjpbXX0%3D) <br/>[![Install on VS Code](https://img.shields.io/badge/Install-VS_Code-FF9900?style=flat-square&logo=visualstudiocode&logoColor=white)](https://insiders.vscode.dev/redirect/mcp/install?name=Cell-Based%20Architecture%20MCP%20Server&config=%7B%22command%22%3A%22uvx%22%2C%22args%22%3A%5B%22awslabs.cell-based-architecture-mcp-server%40latest%22%5D%2C%22env%22%3A%7B%22FASTMCP_LOG_LEVEL%22%3A%22ERROR%22%7D%2C%22disabled%22%3Afalse%2C%22autoApprove%22%3A%5B%5D%7D) |
...
```json
{
  "mcpServers": {
    ...
    "awslabs.cell-based-architecture-mcp-server": {
      "command": "uvx",
      "args": [
        "awslabs.cell-based-architecture-mcp-server@latest"
      ],
      "env": {
        "FASTMCP_LOG_LEVEL": "ERROR"
      },
