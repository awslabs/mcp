...
### 🎬 Media & Entertainment
Manage render farms and creative workloads with AWS Deadline Cloud.

| Server Name | Description | Install |
|-------------|-------------|---------|
| [AWS Deadline Cloud MCP Server](src/deadline-cloud-mcp-server) | Submit jobs, manage render farms, and orchestrate cloud-based rendering workflows with natural language integration for AWS Deadline Cloud services | [![Install](https://img.shields.io/badge/Install-Kiro-9046FF?style=flat-square&logo=kiro)](https://kiro.dev/launch/mcp/add?name=deadline-cloud&config=%7B%22command%22%3A%22pipx%22%2C%22args%22%3A%5B%22run%22%2C%22deadline%5Bmcp%5D%22%2C%22mcp-server%22%5D%2C%22disabled%22%3Afalse%2C%22autoApprove%22%3A%5B%5D%7D) <br/>[![Install](https://img.shields.io/badge/Install-Cursor-blue?style=flat-square&logo=cursor)](https://cursor.com/en/install-mcp?name=deadline-cloud&config=eyJjb21tYW5kIjoicGlweCIsImFyZ3MiOlsicnVuIiwiZGVhZGxpbmVbbWNwXSIsIm1jcC1zZXJ2ZXIiXSwiZGlzYWJsZWQiOmZhbHNlLCJhdXRvQXBwcm92ZSI6W119) <br/>[![Install on VS Code](https://img.shields.io/badge/Install-VS_Code-FF9900?style=flat-square&logo=visualstudiocode&logoColor=white)](https://insiders.vscode.dev/redirect/mcp/install?name=AWS%20Deadline%20Cloud%20MCP%20Server&config=%7B%22command%22%3A%22pipx%22%2C%22args%22%3A%5B%22run%22%2C%22deadline%5Bmcp%5D%22%2C%22mcp-server%22%5D%2C%22disabled%22%3Afalse%2C%22autoApprove%22%3A%5B%5D%7D) |
