...
| Server Name | Description | Install |
|-------------|-------------|---------|
| [ETL Replatforming MCP Server](src/etl-replatforming-mcp-server) | Intelligent ETL framework migration with AI-enhanced parsing and universal workflow conversion between Airflow, Step Functions, and Azure Data Factory | |
...
```json
{
  "mcpServers": {
    "awslabs.etl-replatforming-mcp-server": {
      "command": "uvx",
      "args": [
        "awslabs.etl-replatforming-mcp-server@latest"
      ],
      "env": {
